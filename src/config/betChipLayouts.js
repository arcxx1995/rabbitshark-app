...
export const betChipLayouts = {
  "6-max": {
    ...
    seat_1_left_lower: { x: 18.6, y: 28.5 },
    seat_2_left_upper: { x: 18.6, y: 55.9 },
    seat_3_top: { x: 48, y: 23 },
    seat_4_right_lower: { x: 73.2, y: 27.5 },
    seat_5_right_upper: { x: 73.2, y: 55.9 },
  },
  "8-max": {
    seat_0_hero: { x: 48, y: 60 },
    seat_1_bottom_right: { x: 68.4, y: 61.8 },
    seat_2_right_mid: { x: 73.0, y: 42.0 },
    seat_3_right_upper: { x: 68.4, y: 21.7 },
    seat_4_top_right: { x: 48.0, y: 21.7 },
    seat_5_top_left: { x: 37.3, y: 32.3 },
    seat_6_left_upper: { x: 26.3, y: 21.7 },
    seat_7_left_mid: { x: 18.3, y: 42.0 },
    seat_8_bottom_left: { x: 26.3, y: 61.8 },
  },
  "9-max": {
    seat_0_hero: { x: 48, y: 60 },
    seat_1_bottom_right: { x: 68.4, y: 61.8 },
    ...
    seat_6_left_upper: { x: 18.3, y: 27.9 },
    seat_7_left_mid: { x: 18.3, y: 50.2 },
    seat_8_bottom_left: { x: 26.3, y: 61.8 },
  },
};
